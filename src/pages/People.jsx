...
export default function People() {
  ...
  const COLS = {
    ...
    product: { label: 'מוצר', get: r => <EditableCell row={r} table="people" field="product_id" mode="select" options={productOpts} display={v => { const n = nameOf(productOpts, v); return n ? <span className="badge" style={chipColor(n)}>{n}</span> : '-' }} onSaved={patchRow(r.id)} />, csv: r => r.product?.name },
